...
;(function() {
  ...
  /**
   * Used to match ES templates delimiters.
   * See the [ES spec](https://people.mozilla.org/~jorendorff/es6-draft.html#sec-templates-literal-lexical-components)
   * for more details.
   */
  var reEsTemplate = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;
  ...
  function runInContext(context) {
     ...
     * `sortBy`, `take`, `takeRight`, `templates`, `trim`, `trimLeft`, `trimRight`,
     ...
     *
     * **Note:** In the development build `_.templates` utilizes sourceURLs for easier debugging.
