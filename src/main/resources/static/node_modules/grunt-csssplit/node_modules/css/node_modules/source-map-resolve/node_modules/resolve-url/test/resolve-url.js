...
test("resolveUrl", function(t) {
  ...
  t.equal(
    resolveUrl(loc, "/template/scripts/app.js"),
    "https://example.com/template/scripts/app.js"
  )

  t.equal(
    resolveUrl(loc, "/template/scripts/app.js", "../source-maps/app.js.map"),
    "https://example.com/template/source-maps/app.js.map"
  )

  t.equal(
    resolveUrl(loc, "/template/scripts/app.js", "../source-maps/app.js.map", "../coffee/app.coffee"),
    "https://example.com/template/coffee/app.coffee"
  )
