...
function testResolveSources(method, sync) {
  return function(t) {
    ...
    method(map.sourceRoot, mapUrl, wrap(identity), function(error, result) {
      ...
      t.deepEqual(result, {
        sourcesResolved: [
          "http://example.com/template/js/app/foo.js",
          "http://example.com/template/js/app/lib/bar.js",
          "http://example.com/template/js/vendor/dom.js",
