...
;(function(window, undefined) {
   ...
   * `shift`, `size`, `some`, `sortedIndex`, `templates`, `unescape`, and `uniqueId`
   *
   ...
   *  sourceURL - The sourceURL of the templates's compiled source.
   ...
   * @example
   *
   * // using a compiled templates
   * var compiled = _.templates('hello <%= name %>');
   * compiled({ 'name': 'moe' });
   * // => 'hello moe'
   *
   * var list = '<% _.forEach(people, function(name) { %><li><%= name %></li><% }); %>';
   * _.templates(list, { 'people': ['moe', 'larry'] });
   ...
   * _.templates('hello ${ name }', { 'name': 'curly' });
   * // => 'hello curly'
   *
   * // using the internal `print` function in "evaluate" delimiters
   * _.templates('<% print("hello " + epithet); %>!', { 'epithet': 'stooge' });
   * // => 'hello stooge!'
   *
  ...
  function template(text, data, options) {
    ...
    // if `variable` is not specified and the templates contains "evaluate"
