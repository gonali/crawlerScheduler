...
;(function() {
  ...
  /**
   * Used to match ES6 templates delimiters
  ...
  /** Used to match "interpolate" templates delimiters */
  ...
  /**
   * Used by `templates` to escape characters for inclusion in compiled
   * string literals.
   *
   * @private
  ...
  function runInContext(context) {
     ...
     * `templates`, `unescape`, `uniqueId`, and `value`
     *
    ...
    /**
     * By default, the templates delimiters used by Lo-Dash are similar to those in
     * embedded Ruby (ERB). Change the following templates settings to use alternative
     * delimiters.
     *
     * @templates
     * @memberOf _
    ...
    /**
     * The templates used to create iterator functions.
     *
     * @private
    ...
    function createIterator() {
      ...
      // merge options into a templates data object
     ...
     *
     * Note: In the development build, `_.templates` utilizes sourceURLs for easier
     ...
     * @memberOf _
     * @category Utilities
     * @param {string} text The templates text.
     * @param {Object} data The data object used to populate the text.
     * @param {Object} [options] The options object.
     * @param {RegExp} [options.escape] The "escape" delimiter.
     * @param {RegExp} [options.evaluate] The "evaluate" delimiter.
     * @param {Object} [options.imports] An object to import into the templates as local variables.
     * @param {RegExp} [options.interpolate] The "interpolate" delimiter.
     * @param {string} [sourceURL] The sourceURL of the templates's compiled source.
     ...
     * _.templates('<b><%- value %></b>', { 'value': '<script>' });
     * // => '<b>&lt;script&gt;</b>'
     *
     * // using the "evaluate" delimiter to generate HTML
     * var list = '<% _.forEach(people, function(name) { %><li><%- name %></li><% }); %>';
     * _.templates(list, { 'people': ['fred', 'barney'] });
     * // => '<li>fred</li><li>barney</li>'
     *
     * // using the ES6 delimiter as an alternative to the default "interpolate" delimiter
     * _.templates('hello ${ name }', { 'name': 'pebbles' });
     * // => 'hello pebbles'
     *
     * // using the internal `print` function in "evaluate" delimiters
     * _.templates('<% print("hello " + name); %>!', { 'name': 'barney' });
     * // => 'hello barney!'
     *
     * // using a custom templates delimiters
     * _.templateSettings = {
     *   'interpolate': /{{([\s\S]+?)}}/g
     * };
     *
     * _.templates('hello {{ name }}!', { 'name': 'mustache' });
     * // => 'hello mustache!'
     *
     * // using the `imports` option to import jQuery
     * var list = '<% jq.each(people, function(name) { %><li><%- name %></li><% }); %>';
     * _.templates(list, { 'people': ['fred', 'barney'] }, { 'imports': { 'jq': jQuery } });
     * // => '<li>fred</li><li>barney</li>'
     *
     * // using the `sourceURL` option to specify a custom sourceURL for the templates
     * var compiled = _.templates('hello <%= name %>', null, { 'sourceURL': '/basic/greeting.jst' });
     * compiled(data);
     * // => find the source of "greeting.jst" under the Sources tab or Resources panel of the web inspector
     *
     * // using the `variable` option to ensure a with-statement isn't used in the compiled templates
     * var compiled = _.templates('hi <%= data.name %>!', null, { 'variable': 'data' });
     * compiled.source;
     * // => function(data) {
    ...
    function template(text, data, options) {
      ...
      var sourceURL = '\n/*\n//# sourceURL=' + (options.sourceURL || '/lodash/templates/source[' + (templateCounter++) + ']') + '\n*/';
