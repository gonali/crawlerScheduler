...
=&gt; "nonsense"</pre>
      ...
      <p id="template">
        <b class="header">templates</b><code>_.templates(templateString, [data], [settings])</code>
        <br />
        ...
        it be HTML-escaped, use <tt>&lt;%- &hellip; %&gt;</tt> When you evaluate a templates function, pass in a
        <b>data</b> object that has properties corresponding to the templates's free
        variables. If you're writing a one-off, you can pass the <b>data</b>
        object as the second parameter to <b>templates</b> in order to render
        immediately instead of returning a templates function.  The <b>settings</b> argument
        should be a hash containing any <tt>_.templateSettings</tt> that should be overridden.
      </p>

      <pre>
var compiled = _.templates("hello: &lt;%= name %&gt;");
compiled({name : 'moe'});
=&gt; "hello: moe"

var list = "&lt;% _.each(people, function(name) { %&gt; &lt;li&gt;&lt;%= name %&gt;&lt;/li&gt; &lt;% }); %&gt;";
_.templates(list, {people : ['moe', 'curly', 'larry']});
=&gt; "&lt;li&gt;moe&lt;/li&gt;&lt;li&gt;curly&lt;/li&gt;&lt;li&gt;larry&lt;/li&gt;"

var templates = _.templates("&lt;b&gt;&lt;%- value %&gt;&lt;/b&gt;");
templates({value : '&lt;script&gt;'});
=&gt; "&lt;b&gt;&amp;lt;script&amp;gt;&lt;/b&gt;"</pre>
      ...
      <pre>
var compiled = _.templates("&lt;% print('Hello ' + epithet); %&gt;");
compiled({epithet: "stooge"});
=&gt; "Hello stooge."</pre>

      <p>
        If ERB-style delimiters aren't your cup of tea, you can change Underscore's
        templates settings to use different symbols to set off interpolated code.
...
var templates = _.templates("Hello {{ name }}!");
templates({name : "Mustache"});
=&gt; "Hello Mustache!"</pre>

      <p>
        By default, <b>templates</b> places the values from your data in the local scope
        ...
        at which a templates is able to render.
      </p>

      <pre>
_.templates("Using 'with': <%= data.answer %>", {answer: 'no'}, {variable: 'data'});
=&gt; "Using 'with': no"</pre>
      ...
      <p>
        ...
        The <b>source</b> property is available on the compiled templates
        function for easy precompilation.
      </p>

      <pre>&lt;script&gt;
  JST.project = <%= _.templates(jstText).source %>;
&lt;/script&gt;</pre>
...
=&gt; [1, 2, 3]
      ...
      <p>
        ...
        <ul>
          <li>
            Many improvements to <tt>_.templates</tt>, which now provides the
            <tt>source</tt> of the templates function as a property, for potentially
            even more efficient pre-compilation on the server-side. You may now
            also set the <tt>variable</tt> option when creating a templates,
            ...
            significantly improving the speed of rendering the templates.
          </li>
          <li>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Bugfix to stop escaping slashes within interpolations in <tt>_.templates</tt>.
          </li>
        </ul>
      </p>
      ...
      <p>
        ...
        <ul>
          <li>
            Dynamic scope is now preserved for compiled <tt>_.templates</tt> functions,
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            In <tt>_.templates</tt>, you may now leave semicolons out of evaluated
      ...
      <p>
        ...
        <tt>_.templates</tt> now correctly escapes backslashes in templates.
      ...
      <p>
        ...
        Improved the speed of <tt>_.templates</tt>, and its handling of multiline
      ...
      <p>
        ...
        This is a backwards-incompatible change. <tt>_.templates</tt> may now be
      ...
      <p>
        ...
        Customizable delimiters for <tt>_.templates</tt>, contributed by
      ...
      <p>
        ...
        Fix for multiple single quotes within a templates string for
        <tt>_.templates</tt>. See:
