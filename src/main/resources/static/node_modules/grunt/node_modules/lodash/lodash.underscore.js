...
;(function(window, undefined) {
   ...
   * build and avoiding `_.templates` use, or loading Lo-Dash in a sandboxed page.
   ...
   * _.templates(list, { 'people': ['moe', 'larry', 'curly'] });
   ...
   * var compiled = _.templates('hello <%= data.name %>!', null, { 'variable': 'data' });
   * compiled.source;
   * // => function(data) {
  ...
  // add all template functions to `lodash.prototype`
  mixin(lodash);
